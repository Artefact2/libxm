...
extern const unsigned int XM_PRESCAN_DATA_SIZE;
 ...
 */
xm_context_t* xm_create_context(char* pool, const xm_prescan_data_t* p,
                                const char* moddata,
                                uint32_t moddata_length, uint32_t rate);
 ...
 *
 * @param data pointer to **writeable** module data generated by
 * xm_context_to_libxm().
 */
 ...
 * generated audio)
 */
void xm_get_position(xm_context_t*, uint8_t* pattern_index,
 ...
 * xm_get_nubmer_of_samples(...,instr)-1.
 */
uint64_t xm_get_latest_trigger_of_sample(xm_context_t*, uint16_t instr,
                                         uint16_t sample);
