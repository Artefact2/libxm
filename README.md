...
109871 cerror-expatarimental.libxm
  4308 cerror-expatarimental.libxm.xz
 49240 cerror-expatarimental.xm
  4820 cerror-expatarimental.xm.xz
  7121 libxmtoau.packed
~~~
...
* `xmconvert` will convert a module to the non-portable format. The
  ...
  compresses down to about the same size. The non-portable format can
  be loaded by libxm in much less code, resulting in smaller
  executable sizes.
